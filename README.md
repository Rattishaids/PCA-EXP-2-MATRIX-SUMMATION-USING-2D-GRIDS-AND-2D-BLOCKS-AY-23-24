...
<h3>AIM:</h3>
<h3>RATTISH KUMAR SS</h3>
<h3>REGISTER NO:212224230223</h3>
<h3>EX. NO:2</h3>
<h3>DATE:3.8.26</h3>
...
int main(int argc, char **argv)
{
    ...
    // invoke kernel at host side - Using grid (512, 512) and block (32, 32)
    int dimx = 32;
    int dimy = 32;
    dim3 block(dimx, dimy);
    dim3 grid(512, 512);  // Fixed grid of 512x512
...
## OUTPUT:
<img width="1086" height="200" alt="image" src="https://github.com/user-attachments/assets/c5b017a6-a02b-48dd-9212-6d45fa806352" />
<img width="1025" height="178" alt="image" src="https://github.com/user-attachments/assets/a98f247e-1a0f-4812-9ea0-c17558afd20b" />



## RESULT:
The host took 0.888266 seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in 0.013657 seconds. Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
